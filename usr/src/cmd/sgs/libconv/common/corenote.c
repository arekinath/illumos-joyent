 ...
 *
 * UPANICFGSZ is the real minimum size of the buffer required by
 ...
 * UPANICFGSZ uses information that is not available in the environment of other
 * programs that include the conv.h header file.
 */
#if (CONV_PRUPANIC_BUFSIZE != UPANICFLGSZ)
#define	REPORT_BUFSIZE UPANICFLGSZ
#include "report_bufsize.h"
#error "CONV_PRUPANIC_BUFSIZE does not match UPANICFGSZ"
#endif
