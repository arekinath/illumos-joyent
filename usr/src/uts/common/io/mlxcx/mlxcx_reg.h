...
#define MLXCX_CQ_ARM_CI			(bitdef_t){ \
					.bit_shift = 0, .bit_mask = 0x00ffffff }
#define	MLXCX_CQ_ARM_SEQ		(bitdef_t) { \
					.bit_shift = 28, .bit_mask = 0x30000000 }
...
#define	MLXCX_EQ_LOG_PAGE_SIZE		(bitdef_t) { \
					.bit_shift = 24, .bit_mask = 0x1F000000 }
...
#define	MLXCX_RQ_FLAGS_RLKEY			(1 << 31)
...
#define	MLXCX_SQ_FLAGS_RLKEY			(1 << 31)
...
typedef enum {
	...
	MLXCX_FLOW_CAP_PROPS_SUPPORT			= 1 << 31
